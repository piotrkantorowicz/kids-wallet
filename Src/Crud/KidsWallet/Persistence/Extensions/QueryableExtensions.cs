...
public static class QueryableExtensions
{
    ...
    {
        return includes.Aggregate(queryable, (current, include) => current.IncludeIfNotNull(include));
    }
    ...
    {
        return !string.IsNullOrEmpty(include) ? queryable.Include(include) : queryable;
    }
}